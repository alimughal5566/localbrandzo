                                ...
                                @if($prod->user->is_vendor == 2)
													...
													<div class="col-lg-4 col-md-6">
															<div class="single-box">
																<div class="left-area">
																	<img class="rounded" src="{{ $prod->photo ? asset('assets/images/thumbnails/'.$prod->thumbnail):asset('assets/images/noimage.png') }}" alt="">
																</div>
																<div class="right-area">
																		<h4 class="price text-white">{{ $prod->showPrice() }} <del>{{ $prod->showPreviousPrice() }}</del> </h4>
																	<div class="stars">
																		<div class="ratings">
								...
								<div class="col-lg-4 col-md-6 ">
										<div class="single-box">
											...
											<div class="right-area">
												...
												<p class="text "><a class="text-white" href="{{ route('front.product',$prod->slug) }}">{{ strlen($prod->name) > 65 ? substr($prod->name,0,65).'...' : $prod->name }}</a></p>
