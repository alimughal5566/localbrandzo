                    ...
                    <div class="left-content">
                        <div class="list">
                            <ul>
                                ...
                                @if($gs->is_language == 1)
                                    <li>
                                        <div class="language-selector">
                                            <i class="fas fa-globe-americas" style="color: black;"></i>
                                            <select name="language" class="language selectors nice colorblack">
                                ...
                                @if($gs->is_currency == 1)
                                    <li>
                                        <div class="currency-selector colorblack">
                                            ...
                                            <select name="currency" class="currency selectors nice colorblack">
                        ...
                        <div class="list">
                            <ul>
                                @if(!Auth::guard('web')->check())
                                    <li class="login colorblack">
                                        <a href="{{ route('user.login') }}" class="sign-log colorblack">
                                            <div class="links">
                                                <span class="sign-in colorblack">{{ $langg->lang12 }}</span> <span>|</span>
                                                <span class="join colorblack">{{ $langg->lang13 }}</span>
                                            </div>
                                        </a>
                                    </li>
                                @else
                                    ...
                                    <li>
                                        @if(Auth::check())
                                            @if(Auth::guard('web')->user()->is_vendor == 2)
                                                <a href="{{ route('vendor-dashboard') }}" class="sell-btn colorblack">{{ $langg->lang220 }}</a>
                                            @else
                                                <a href="{{ route('user-package') }}" class="sell-btn colorblack">{{ $langg->lang220 }}</a>
                                            @endif
                                    </li>
                                @else
                                    <li>
                                        <a href="javascript:;" data-toggle="modal" data-target="#vendor-login" class="sell-btn colorblack">{{ $langg->lang220 }}</a>
                                    </li>
                                @endif
                                @endif
            ...
            <div class="col-lg-8 col-sm-12 remove-padding order-last order-sm-2 order-md-2">
                <div class="search-box-wrapper">
                    <div class="search-box">
                        <div class="categori-container colorblack" id="catSelectForm">
                            <select name="category" id="category_select" class="categoris colorblack">
                        ...
                        <form id="searchForm" class="search-form" action="{{ route('front.category', [Request::route('category'),Request::route('subcategory'),Request::route('childcategory')]) }}" method="GET">
                            ...
                            <button type="submit"><i class="icofont-search-1 colorblack"></i></button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <li class="wishlist"  data-toggle="tooltip" data-placement="top" title="{{ $langg->lang9 }}">
                            ...
                            @else
                                <a href="javascript:;" data-toggle="modal" id="wish-btn" data-target="#comment-log-reg" class="wish">
                                    <i class="far fa-heart"></i>
                                    <span class="colorblack" id="wishlist-count">0</span>
                                </a>
                            @endif
                        </li>
                        <li class="compare"  data-toggle="tooltip" data-placement="top" title="{{ $langg->lang10 }}">
                            <a href="{{ route('product.compare') }}" class="wish compare-product">
                                <div class="icon">
                                    ...
                                    <span class="colorblack" id="compare-count">{{ Session::has('compare') ? count(Session::get('compare')->items) : '0' }}</span>
                                </div>
                            </a>
                        </li>
