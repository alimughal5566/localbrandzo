...
@section('content')
	<section class="bg-imgesetting  py-5"
			 style="background-image: url({{asset('assets/images/bg-imges/check-outimg.png') }});background-position: right;" >
		<div class="container">
			<div class="row py-3">
				<div class="col-12 pt-5">
					<h2 class="text-uppercase mt-3">Place your order</h2>
					<p class="text-uppercase lato-new-font mb-5 1 pb-3">
	...
	<section class="checkout" style="background: #EBEBEB" >
		<div class="container">
			<div class="row">
					...
					<div class="checkout-area mb-0 pb-0">
						<div class="checkout-process">
							<ul class="nav"  role="tablist">
								<li class="nav-item">
									<a class="nav-link active w-100 remov-after-icon remov-before-icon" id="pills-step1-tab" data-toggle="pill" href="#pills-step1" role="tab" aria-controls="pills-step1" aria-selected="true">
										<span>1</span> {{ $langg->lang743 }}
										<i class="far fa-address-card"></i>
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link w-100 remov-after-icon remov-before-icon disabled" id="pills-step2-tab" data-toggle="pill" href="#pills-step2" role="tab" aria-controls="pills-step2" aria-selected="false" >
										<span>2</span> {{ $langg->lang744 }}
										<i class="fas fa-dolly"></i>
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link w-100 remov-after-icon remov-before-icon disabled" id="pills-step3-tab" data-toggle="pill" href="#pills-step3" role="tab" aria-controls="pills-step3" aria-selected="false">
			...
			<div class="row">
				...
				<div class="col-lg-8 order-last order-lg-first">
					...
					<form id="twocheckout" action="" method="POST" class="checkoutform">
						...
						<div class="checkout-area bg-white rounded">
									...
									<div class="content-box">
										...
										<div class="content">
											<div class="personal-info">
												<h5 class="title perpal-color lato-new-font-o text-uppercase">
													{{ $langg->lang746 }} :
												</h5>
												<div class="row">
													<div class="col-lg-6">
												...
												<div class="row">
													...
													<div class="col-lg-6">
														<input class="form-control" type="text" name="state"
															   placeholder="{{ $langg->lang830 }}" required=""
											...
											<div class="row {{ $digital == 1 ? 'd-none' : '' }}">
												<div class="col-lg-12 mt-3 ">
													...
													<label for="ship-diff-address" class="danger-color">{{ $langg->lang160 }}</label>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-lg-12  mt-3">
													<div class="bottom-area paystack-area-btn">
														<button type="submit"  class="px-4 imgelikebtn">{{ $langg->lang753 }}</button>
													</div>
														...
														<div class="product-content">
															...
															@if(!empty($product['color']))
																<div class="unit-price">
																	...
																	<span id="color-bar" style="border: 10px solid {{$product['color'] == "" ? "white" : '#'.$product['color']}};border-radius: 5px"></span>
																</div>
															@endif
									...
									<div class="content-box">
										<div class="content">
											...
											<div class="billing-info-area {{ $digital == 1 ? 'd-none' : '' }}">
												<h4 class="title  perpal-color lato-new-font-o text-uppercase">
													{{ $langg->lang758 }}
												</h4>
												<ul class="info-list">
													<li>
													...
													<div class="col-lg-12">
														<div class="nav flex-column"  role="tablist" aria-orientation="vertical">
															...
															@if($gs->is_authorize == 1)
																<a class="nav-link payment" data-val="" data-show="yes" data-form="{{route('authorize.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'authorize','slug2' => 0]) }}" id="v-pills-tab9-tab" data-toggle="pill" href="#v-pills-tab9" role="tab" aria-controls="v-pills-tab9" aria-selected="false">
																	<div class="icon">
																		<span class="radio"></span>
																	</div>
																	<p>
															...
															@if($gs->is_mercado == 1)
																<a class="nav-link payment" data-val="" data-show="no" data-form="{{route('mercadopago.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'mercadopago','slug2' => 0]) }}" id="v-pills-tab10-tab" data-toggle="pill" href="#v-pills-tab10" role="tab" aria-controls="v-pills-tab10" aria-selected="false">
																	<div class="icon">
																		<span class="radio"></span>
																	</div>
																	<p>
															...
															@if($gs->is_flutter== 1)
																...
																<a class="nav-link payment" data-val="flutter" data-show="no" data-form="{{route('flutter.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'flutter','slug2' => 0]) }}" id="v-pills-tab11-tab" data-toggle="pill" href="#v-pills-tab11" role="tab" aria-controls="v-pills-tab11" aria-selected="false">
																	<div class="icon">
																		<span class="radio"></span>
																	</div>
																	<p>
															...
															@if($gs->is_twocheckout == 1)
																...
																<a class="nav-link payment" data-val="twocheckout" data-show="yes" data-form="{{route('twocheckout.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'twocheckout','slug2' => 0]) }}" id="v-pills-tab12-tab" data-toggle="pill" href="#v-pills-tab12" role="tab" aria-controls="v-pills-tab12" aria-selected="false">
																	<div class="icon">
																		<span class="radio"></span>
																	</div>
																	<p>
															...
															@if($gs->is_voguepay == 1)
																...
																<a class="nav-link payment" data-val="voguepay" data-show="no" data-form="{{route('voguepay.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'voguepay','slug2' => 0]) }}" id="v-pills-tab14-tab" data-toggle="pill" href="#v-pills-tab14" role="tab" aria-controls="v-pills-tab14" aria-selected="false">
																	<div class="icon">
																		<span class="radio"></span>
																	</div>
																	<p>
				...
				@if(Session::has('cart'))
					<div class="col-lg-4">
						<div class="right-area ">
							<div class="order-box bg-white border rounded ">
								<h4 class="title  perpal-color font-weight-bolder lato-new-font-o text-uppercase">{{ $langg->lang127 }}</h4>
								...
								<div class="cupon-box">
									...
									<div id="coupon-link" class="danger-color text-decoration-none font-weight-bolder">
								...
								@if($digital == 0)
									...
									<div class="packeging-area">
										<h4 class="title  perpal-color lato-new-font-o text-uppercase ">{{ $langg->lang765 }}</h4>
									...
									<div class="packeging-area">
										<h4 class="title perpal-color lato-new-font-o text-uppercase">{{ $langg->lang766 }}</h4>
									...
									<div class="final-price">
										<span class="perpal-color lato-new-font-o text-uppercase">{{ $langg->lang767 }} :</span>
										@if(Session::has('coupon_total'))
											@if($gs->currency_format == 0)
										...
										<div class="wallet-box mt-3 d-none">
											...
											<form id="wallet-form">
												...
												@if(Session::has('coupon_total'))
													...
													<input type="number" placeholder="{{ $langg->lang817 }}" step="0.01" id="wallet-amount" min="1" required="" value="{{ $totalPrice <= ( Auth::user()->balance * $curr->value ) ? $totalPrice :  round(Auth::user()->balance * $curr->value ,2) }}">

												@elseif(Session::has('coupon_total1'))

													<input type="number" placeholder="{{ $langg->lang817 }}" step="0.01" id="wallet-amount" min="1" required="" value="{{ preg_replace("/[^0-9,.]/", "", Session::get('coupon_total1')) <= ( Auth::user()->balance * $curr->value ) ? preg_replace("/[^0-9,.]/", "", Session::get('coupon_total1')) :  round(Auth::user()->balance * $curr->value ,2) }}">

												@else

													<input type="number" placeholder="{{ $langg->lang817 }}t" step="0.01" id="wallet-amount" min="1" required="" value="{{ round($totalPrice * $curr->value,2) <= ( Auth::user()->balance * $curr->value ) ? round($totalPrice * $curr->value,2) :  round(Auth::user()->balance * $curr->value ,2) }}">
