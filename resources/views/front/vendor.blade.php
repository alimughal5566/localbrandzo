...
@section('content')
    <section class="bg-imgesetting  py-5"
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p class="mt-2 lato-new-font text-uppercase mb-2 pt-5">{{ $langg->lang226 }}</p>
                    <h2 class="mb-5"> {{ $vendor->shop_name }}</h2>
                </div>
            </div>
        </div>
    </section>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <input type="text" class="input-field" readonly=""
                                                               placeholder="Send To {{ $vendor->shop_name }}"
                                                               readonly="">
                                                    </li>
