...
@section('content')
  ...
  <section class="product-details-page" style="background: #EEEEEE">
    <div class="container">
   {{--   <div class="row pb-3">
        <div class="col-md-4">
      ...
      <div class="row">
        <div class="col-12">
          <h1 class="font-weight-bold times-new-font">Makeup Fixer <br>
            (180ml)</h1>
          <p class="text-uppercase lato-new-font my-3">
...
/
            @if($productt->childcategory_id != null)
              <a href="{{ route('front.childcat',['slug1' => $productt->category->slug, 'slug2' => $productt->subcategory->slug, 'slug3' => $productt->childcategory->slug]) }}">
                {{$productt->childcategory->name}}
              </a>
            @endif
            /
            <a class="font-weight-bold"
               href="{{ route('front.product', $productt->slug) }}">{{ $productt->name }}</a>
          </p>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-lg-5 col-md-12">
              ...
              <div class="xzoom-container ">
                <img class="xzoom5 rounded w-100" id="xzoom-magnific"
                ...
                <div class="xzoom-thumbs">
                  ...
                  <div class="all-slider imges-slider">
                    ...
                    @foreach($productt->galleries as $gal)
                      ...
                      <a class="" href="{{asset('assets/images/galleries/'.$gal->photo)}}">
                        <img class="xzoom-gallery5 mx-2  border-0 px-2" width="80"
            ...
            <div class="col-lg-7">
              <div class="right-area ">
                <div class="product-info bg-white rounded p-2">
                  <h4 class="product-name text-uppercase">{{ $productt->name }}</h4>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div id="product-details-tab">
                ...
                <div class="tab-content-wrapper product-detailss">
        ...
        <div class="col-lg-4">
          ...
          @if(!empty($productt->whole_sell_qty))
            <div class="table-area wholesell-details-page rounded bg-theam-gradeant">
              <h3>{{ $langg->lang770 }}</h3>
              <table class="table text-center remove-table-borders">
                <tr>
                  <th>{{ $langg->lang768 }}</th>
                  <th>{{ $langg->lang769 }}</th>
                </tr>
          ...
          <div class="seller-info bg-white rounded border ">
            <div class="content py-1">
              <h4 class="font-weight-bold danger-color">
                {{ $langg->lang246 }}
              </h4>
                  ...
                  @if( $productt->user_id  != 0)
                    <li>
                      <a href="{{ route('front.vendor',str_replace(' ', '-', $productt->user->shop_name)) }}"
                         class="view-stor  bg-theam-gradeant py-2">{{ $langg->lang249 }}</a></li>
                  @endif
                  ...
                  @if(Auth::guard('web')->check())
                    ...
                    <li>
                      ...
                      0)
                        ...
                        <a class=" bg-theam-gradeant py-2" href="javascript:;">
                      ...
                      @else
                        ...
                        <a class="favorite-prod view-stor bg-theam-gradeant py-2"
                    ...
                    <li>
                      <a class="view-stor bg-theam-gradeant py-2" href="javascript:;"
                         data-toggle="modal" data-target="#vendorform1">
          ...
          <div class="categori bg-white rounded border mt-30">
            <div class="section-top mx-2">
              <h2 class="section-title">
                {{ $langg->lang245 }}
              </h2>
            </div>
            <div class="hot-and-new-item-slider my-2 px-5 ">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="section-title font-weight-bold text-uppercase mt-4">
              {{ $langg->lang245 }}
            </h3>
          </div>
        </div>
